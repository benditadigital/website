  ...
  return (
    <div className="portfolio-page font-poppins">
      ...
      <div className="grid grid-cols-2 py-10 my-10 justify-center items-center gap-10 text-white">
        <div>
          <h2 className="text-[41px] pr-10 font-medium flex gap-4 text-center md:text-right justify-center md:justify-end">
            Deu
      ...
      <div className="container max-w-[1024px] mx-auto justify-center items-center text-white">
      ...
      <div className="container text-center max-w-[1024px] flex flex-col mx-auto justify-center items-center text-white mb-[125px]">
        <h3 className="text-[32px] font-semibold my-10">
          Somos apaixonados pela arte!
        </h3>
        <div className="text-[16px] font-light max-w-[665px] text-justify">
